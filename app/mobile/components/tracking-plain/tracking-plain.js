TrackingPlain = Component.create({
  ...
  plainDown:function(callType){
    ...
    if(this.plainState=="up"){
      ...
      this.subElm('.tracking-plain-title').css({top:-500});
      this.subElm('.title-background').css({top:-550});
  ...
  plainUp: function(){
    ...
    if(this.plainState=="down"){
      ...
      this.subElm('.tracking-plain-title').css({top:-200});
      this.subElm('.title-background').css({top:-280});
    }
  },
